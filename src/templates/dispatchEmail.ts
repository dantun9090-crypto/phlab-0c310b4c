...
export function buildDispatchEmail(opts: DispatchEmailOptions): string {
  ...
  const content = `
    <div>
      ...
      ${ctaButton('Track Your Order', opts.trackingUrl || 'https://www.prohealthpeptides.co.uk/account')}

      ${divider()}

      <p style="color:${C.textDimmed};font-size:11px;line-height:1.6;margin:0;text-align:center;">
        Questions about your delivery? <a href="mailto:info@prohealthpeptides.co.uk" style="color:${C.accent};text-decoration:none;">info@prohealthpeptides.co.uk</a><br>
