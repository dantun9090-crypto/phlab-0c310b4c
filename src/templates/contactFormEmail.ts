      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr>
          <td style="background:${C.bgCardDark};border:1px solid ${C.border};border-top:none;border-radius:0 0 16px 16px;padding:16px 32px;text-align:center;">
            ...
            <div style="font-size:11px;color:${C.textDimmed};">PH Labs Admin Panel · <a href="https://phlabs.co.uk" style="color:${C.accent};text-decoration:none;">phlabs.co.uk</a></div>
          </td>
        </tr>
