    ...
    const tab = (() => {
      switch (activeTab) {
       ...
       case 'blankwatchdog': return <BlankWatchdogTab />;
        ...
        case 'cacherecovery': return <CacheRecoveryTab />;
