...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'emailbranding', label: 'Email Branding', icon: Mail },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'reindexhook', label: 'Fast Reindex (Landing pages)', icon: Send },
    ],
  },
  {
    label: 'SEO',
    items: [
      ...
      { id: 'marketingcoverage', label: 'Marketing Coverage', icon: Search },
...
const ITEM_ACCENTS: Record<string, string> = {
  ...
  emailbranding: 'from-indigo-500 to-purple-600',
