      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[#9cb8d9] text-xs mt-0.5">
              Offline app-shell service worker is disabled. Returning browsers now receive service-worker cleanup, Cache Storage cleanup, manual stale-asset recovery, and refresh-loop protection.
            </p>
          </div>
        </div>
