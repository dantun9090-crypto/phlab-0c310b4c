              ...
              {enrichedFeatured.slice(0, 6).map((p: any, i: number) => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden" style={{ aspectRatio: '4/3', background: '#040d1a' }}>
                    {p.image ? (
                      <img {...cfImgProps(p.image, { widths: [200, 300, 400, 600, 800], sizes: '(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw' })} alt={`${p.name} research peptide vial`} loading="lazy" width="400" height="300" decoding="async" style={{ display: 'block', width: '100%', height: '100%', objectFit: 'contain' }} className="transition-transform duration-700 group-hover:scale-105" />
                    ) : (
