    ...
    <div className="min-h-screen bg-[#030812] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-[#6b8fba] text-sm leading-relaxed max-w-xs mx-auto">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            {settings.facebookUrl && (
              <a href={settings.facebookUrl} target="_blank" rel="noopener noreferrer"
                ...
                <svg className="w-4 h-4 text-[#6b8fba] hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {settings.instagramUrl && (
              <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer"
                ...
                <svg className="w-4 h-4 text-[#6b8fba]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            {settings.twitterUrl && (
              <a href={settings.twitterUrl} target="_blank" rel="noopener noreferrer"
                ...
                <svg className="w-4 h-4 text-[#6b8fba]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {mode === 'login' ? (
              <motion.div key="login" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.25 }}>
                <div className="mb-8">
                  ...
                  <p className="text-[#6b8fba] mt-1.5 text-sm">Sign in to your account to continue</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label htmlFor="login-email" className="block text-[#6b8fba] text-xs font-medium mb-1.5 tracking-wide">Email address</label>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      <label htmlFor="login-password" className="text-[#6b8fba] text-xs font-medium tracking-wide">Password</label>
              ...
              <motion.div key="forgot" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.25 }}>
                <div className="mb-8">
                  ...
                  <p className="text-[#6b8fba] mt-1.5 text-sm">{resetSent ? 'A reset link is on its way.' : "We'll email you a reset link."}</p>
                </div>
                ...
                {resetSent ? (
                  <div className="text-center py-6 space-y-4">
                    ...
                    <p className="text-[#6b8fba] text-sm">Reset link sent to <span className="text-white font-medium">{resetEmail}</span>. Check your spam folder too.</p>
                  ...
                  <>
                    ...
                    <form onSubmit={handleReset} className="space-y-4">
                      <div>
                        <label htmlFor="reset-email" className="block text-[#6b8fba] text-xs font-medium mb-1.5">Email address</label>
                        <div className="relative">
