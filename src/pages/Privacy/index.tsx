    ...
    <div className="min-h-screen bg-[#060f1e] pt-24 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#6b8fba]">ProHealth Peptides | www.prohealthpeptides.co.uk</p>
          ...
          <section className="bg-[#0b1a30]/70 border border-white/[0.07] rounded-2xl p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#6b8fba] leading-relaxed mb-3">
          ...
          <section className="bg-[#0b1a30]/70 border border-white/[0.07] rounded-2xl p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#6b8fba] leading-relaxed mb-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Legal name, business/institutional affiliation, and professional titles.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Verified billing address, shipping address, electronic mail address, and telephone numbers.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Details regarding products purchased, timestamps, and payment confirmation (excluding raw credit card data, which is handled by PCI-compliant processors).</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Internet Protocol (IP) address, browser fingerprints, and interaction logs for security and fraud prevention.</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> To process and dispatch orders for research chemicals.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> To maintain financial records for HMRC and ensure compliance with chemical distribution regulations.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> To prevent fraudulent transactions and ensure the security of our digital infrastructure.</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[#6b8fba]">Information may be audited to ensure compliance with research-only distribution standards.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2"></div>
                    <p className="text-[#6b8fba]">We reserve the right to cross-reference data to prevent the diversion of research materials for non-laboratory use.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Request a copy of the data we hold.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pink-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Correct inaccurate or incomplete data.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pink-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Request deletion of data where no legal override exists.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pink-400 mt-2"></div>
                    <div>
                      ...
                      <span className="text-[#6b8fba]"> Limit how we use your data during disputes.</span>
                    </div>
                  </div>
                </div>
                <p className="text-[#6b8fba] mt-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[#6b8fba]"><strong className="text-white">Hyperlink:</strong> This policy is linked in the website footer and at the checkout stage.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2"></div>
                    <p className="text-[#6b8fba]"><strong className="text-white">DPO:</strong> Contact our support team for Data Protection Officer inquiries.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2"></div>
                    <p className="text-[#6b8fba]"><strong className="text-white">Consent:</strong> We use active opt-in mechanisms for any marketing communications to remain compliant.</p>
                  </div>
                </div>
              </div>
            </div>
