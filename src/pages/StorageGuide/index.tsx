...
export default function StorageGuide() {
  useEffect(() => {
    ...
    setMeta('og:url', 'https://www.prohealthpeptides.co.uk/storage-guide', true);
    const canonical = document.querySelector('link[rel="canonical"]');
    if (canonical) canonical.setAttribute('href', 'https://www.prohealthpeptides.co.uk/storage-guide');
  }, []);
