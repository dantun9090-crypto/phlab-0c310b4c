  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-3 text-[#6b8fba] leading-relaxed text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="rounded-2xl p-4" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
                ...
                <p className="text-[#6b8fba] mt-1">{opt.price}</p>
                <p className="text-[#3a5a82] text-xs mt-0.5">{opt.sub}</p>
              </div>
            ))}
          </div>
          <p className="text-[#6b8fba] leading-relaxed">Orders placed Monday–Friday before 1pm are typically dispatched the same working day. Orders placed after 1pm, on weekends, or on UK bank holidays will be dispatched the next working day.</p>
        </div>
      ),
    },
    {
        ...
        <div className="space-y-3 text-sm">
          <div className="rounded-2xl px-5 py-4 flex items-center gap-4" style={{ background: 'rgba(16,185,129,0.07)', border: '1px solid rgba(16,185,129,0.2)' }}>
            ...
            <div>
              ...
              <p className="text-[#6b8fba] text-xs mt-0.5">Applied automatically at checkout. No code required.</p>
            </div>
          </div>
          <p className="text-[#6b8fba] leading-relaxed">Orders below £50 are subject to a £3.99 standard delivery charge. Express delivery is £6.99 regardless of order value.</p>
        </div>
      ),
    },
    {
    ...
    <div className="min-h-screen bg-[#060f1e] pt-24 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#6b8fba] text-sm">Last updated: May 2026</p>
        ...
        <div className="mt-12 rounded-2xl p-6 text-center" style={{ background: '#0b1a30', border: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          <p className="text-[#6b8fba] text-sm mb-4">We typically respond within one working day.</p>
          <Link
            to="/contact"
