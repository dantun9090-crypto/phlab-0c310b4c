        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {data.heroImageUrl && (
              ...
              >
                <img src={data.heroImageUrl} alt={data.heroTitle || "PH Labs research peptides — UK laboratory supplier"} className="w-full h-80 object-cover" loading="eager" fetchPriority="high" />
              </motion.div>
            )}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
