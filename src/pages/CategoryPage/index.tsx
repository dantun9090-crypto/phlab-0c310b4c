            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: config?.label, item: `https://www.prohealthpeptides.co.uk/products/category/${slug}` },
                ],
              }),
            }}
          />
              ...
              dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                  ...
                  itemListElement: sorted.map((p, i) => ({
                    ...
                    position: i + 1,
                    name: p.name,
                    url: `https://www.prohealthpeptides.co.uk/products/${p.slug ?? p.name.toLowerCase().replace(/\s+/g, '-')}`,
                  })),
                }),
              }}
            />
