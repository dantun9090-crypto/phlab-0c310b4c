...
export const RESEARCH_CONTENT: Record<string, ResearchContent> = {
  ...
  "retatrutide-research-peptide": {
    overview:
      "Retatrutide (LY3437943) is a 39-residue synthetic acylated peptide engineered as a balanced triple agonist at the GIP, GLP-1, and glucagon receptors. Molecular formula C221H343N51O63, monoisotopic mass ≈ 4731 Da; CAS 2381089-83-2. Disclosed by Eli Lilly research (Coskun et al., Nat Metab, 2022), it incorporates a C20 fatty diacid moiety at Lys17 enabling non-covalent albumin association, which extends in-vivo half-life in rodent models. In-vitro pharmacology in CHO-K1 cell lines stably transfected with human GIPR, GLP-1R, and GCGR demonstrates concentration-dependent cAMP accumulation with EC50 values in the picomolar-to-low-nanomolar range across all three receptors (Urva et al., 2022). Within laboratory models retatrutide serves as a reference triagonist for receptor-pharmacology assays, β-arrestin recruitment (PathHunter platforms), and comparative incretin-signalling work alongside dual-agonist and mono-agonist references. The retained glucagon-receptor component differentiates it from tirzepatide in mechanistic in-vitro experiments probing hepatic lipid-metabolism endpoints in HepG2 and primary hepatocyte cultures.",
    applications:
      "Used in receptor-pharmacology research: cAMP accumulation assays in HEK293 and CHO-K1 lines stably expressing human GIPR, GLP-1R, or GCGR; β-arrestin-2 recruitment via DiscoverX PathHunter; and competition binding against [125I]-GLP-1 in transfected membranes. Typical in-vitro concentrations span 1 pM–100 nM for dose-response curves. Mitochondrial-respiration studies in primary hepatocytes and INS-1 832/13 β-cell lines explore receptor-pathway crosstalk. Synergistic-compound research pairs retatrutide with tirzepatide and semaglutide as reference dual- and mono-agonists to deconvolute GIP, GLP-1, and glucagon-receptor contributions. Selective antagonists — Ex-9(39), GIP(3-30)NH2, des-His1-[Glu9]-glucagon(1-29) — are used to isolate individual receptor signals in the same assay panels.",
    prepStorage:
      "Supplied as a lyophilised white powder in a sealed vial under inert atmosphere. Reconstitute aseptically with bacteriostatic water (0.9% benzyl alcohol) or sterile sodium acetate buffer (pH 4.0) to a working stock (typical 1 mg/mL). Equilibrate the vial to room temperature before opening to prevent moisture condensation. Reconstituted solutions are stable for up to 28 days at 2–8 °C; for long-term storage prepare single-use aliquots at −20 °C or below. Limit freeze-thaw cycles to three. Handle in a fume hood with nitrile gloves and lab coat — analytical reference material for in-vitro research use only.",
    qualityVerification:
      "Each batch is characterised by reverse-phase HPLC (C18 column, 0.1% TFA / acetonitrile gradient) with a release specification of ≥99.0% purity by peak area at 220 nm. Identity is confirmed by ESI mass spectrometry against the theoretical monoisotopic mass. Counter-ion (TFA), residual solvents, and water content (Karl Fischer) are recorded per lot. A batch-specific Certificate of Analysis accompanies each unit and includes endotoxin (LAL) and bioburden screening for laboratory-handling assessment.",
    faqs: [
      ...
      { q: "Which in-vitro receptor systems use retatrutide?", a: "CHO-K1 and HEK293 cell lines stably expressing human GIPR, GLP-1R, or GCGR are standard for cAMP and β-arrestin recruitment research." },
      { q: "What reconstitution diluent is recommended for laboratory use?", a: "Bacteriostatic water (0.9% benzyl alcohol) or sterile sodium acetate buffer at pH 4.0 for in-vitro stock preparation." },
      { q: "How should reconstituted retatrutide be stored?", a: "Aliquot into single-use volumes at −20 °C or below; avoid more than three freeze-thaw cycles for assay reproducibility." },
      { q: "What is the documented shelf life of the lyophilised compound?", a: "Sealed lyophilisate retains specification for 24 months at −20 °C under nitrogen headspace." },
  ...
  "bpc-157": {
    ...
    applications:
      "Used in tissue-repair-focused research: scratch-closure assays in HUVEC and primary tendon fibroblast cultures, Matrigel tube-formation studies of in-vitro angiogenesis, and collagen-synthesis quantification (Sirius Red, hydroxyproline) in dermal fibroblast monolayers. Typical in-vitro concentrations