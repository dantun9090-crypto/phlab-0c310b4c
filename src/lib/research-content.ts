...
export const RESEARCH_CONTENT: Record<string, ResearchContent> = {
  ...
  "tirzepatide-research-peptide": {
    ...
    structuralDetail: `Tirzepatide is assembled by Fmoc-based solid-phase peptide synthesis on a Rink amide resin, with orthogonal allyl/alloc protection at the Lys20 ε-amine to permit selective on-resin acylation with the γ-Glu-C20 fatty-diacid albumin-binding pendant. The 39-residue backbone is derived from the native GIP sequence and incorporates two 2-aminoisobutyric acid (Aib) residues at positions 2 and 13 — non-canonical α,α-disubstituted residues that suppress dipeptidyl-peptidase-4 (DPP-4) cleavage and stabilise the helical conformation required for dual receptor engagement (Coskun et al., Mol Metab 2018). Following global deprotection with TFA/TIS/H2O/EDT, the crude peptide is precipitated in cold MTBE, lyophilised, and purified by preparative C18 reverse-phase chromatography. The C20 fatty-diacid side chain mediates non-covalent association with serum albumin in in-vitro plasma-stability assays, extending the apparent in-vitro half-life relative to non-acylated GIP/GLP-1 analogues. Identity is confirmed against the theoretical monoisotopic mass of 4813.5 Da; the observed ESI-MS [M+5H]5+ envelope centres at m/z ≈ 963.7, with the deconvoluted mass matching the calculated value within 0.5 Da. Tirzepatide contains no cysteine residues, so disulfide-bond mapping is not applicable; tryptic-digest LC-MS/MS sequence coverage maps are recorded per release lot.`,
    methodDetail: `Release HPLC is run on a 4.6 × 250 mm, 5 µm C18 column (Phenomenex Luna or Waters XBridge BEH) thermostatted at 30 °C, with mobile phase A 0.1% TFA in water and mobile phase B 0.1% TFA in acetonitrile. A typical analytical gradient ramps from 28% B to 55% B over 30 minutes at 1.0 mL/min with UV detection at 220 nm; tirzepatide elutes at approximately 19–21 minutes. The release specification is ≥99.0% main-peak area with no single related-substance peak above 0.5%. System suitability is established with reference-standard injections in triplicate at the start of each sequence (%RSD < 1.0% on retention time, < 2.0% on peak area). Identity is confirmed in a parallel LC-MS run using a 0.1% formic acid gradient on a UPLC C18 column coupled to an ESI-Q-TOF spectrometer scanning m/z 500–2000; deconvoluted mass must match the calculated monoisotopic value within 1 Da. Counter-ion content (TFA) is quantified by ion chromatography and typically reports 4–10% w/w. Residual organic solvents (acetonitrile, MTBE, isopropanol) are screened by headspace GC against ICH Q3C class-2 and class-3 limits. Water content is measured by coulometric Karl Fischer on a 10–20 mg sub-sample. Endotoxin is quantified by kinetic-chromogenic LAL (limit < 5 EU/mg) and bioburden by membrane filtration with TSA/SDA incubation. All release data are compiled into the batch-specific Certificate of Analysis shipped with each vial.`,
    receptorPharmacology: `Tirzepatide is the canonical dual GIP/GLP-1 receptor agonist reference in comparative incretin-receptor assay panels, sitting between selective GLP-1R agonists (semaglutide, liraglutide) and the balanced triagonist retatrutide. In HEK293 lines stably expressing human GLP-1R or GIPR coupled to a cAMP biosensor, tirzepatide produces concentration-dependent cAMP accumulation with reported EC50 values of approximately 0.93 nM at GLP-1R and 0.30 nM at GIPR (Willard et al., JCI Insight 2020). Critically, tirzepatide displays imbalanced and biased agonism at GLP-1R: relative to native GLP-1, β-arrestin-2 recruitment (PathHunter, Tango) is substantially reduced per unit cAMP signal, while GIPR β-arrestin coupling more closely tracks the native ligand. This biased profile has driven a body of in-vitro receptor-internalisation imaging using SNAP-tag GLP-1R constructs in INS-1 832/13 β-cell lines, where tirzepatide elicits less receptor internalisation than semaglutide. Antagonist tools used in companion deconvolution assays include exendin-9(39) (GLP-1R block) and GIP(3-30)NH2 (GIPR block); tirzepatide shows no measurable activity at GCGR, which differentiates it from retatrutide in hepatocyte PKA/ATGL experiments. In primary rat-islet preparations, tirzepatide enhances glucose-stimulated insulin secretion at 1–100 nM with the GIPR contribution suppressed by GIP(3-30)NH2 pre-incubation. The albumin-bound fraction can be modelled in vitro with 4% human serum albumin in the incubation buffer; the C20 diacid pendant is the principal determinant of extended apparent half-life.`,
    references: [
      { citation: "Coskun T. et al. (2018). LY3298176, a novel dual GIP and GLP-1 receptor agonist for the treatment of type 2 diabetes mellitus: from discovery to clinical proof of concept. Molecular Metabolism.", doi: "10.1016/j.molmet.2018.09.009" },
      { citation: "Willard F.S. et al. (2020). Tirzepatide is an imbalanced and biased dual GIP and GLP-1 receptor agonist. JCI Insight.", doi: "10.1172/jci.insight.140532" },
      { citation: "Frías J.P. et al. (2021). Tirzepatide versus Semaglutide Once Weekly in Patients with Type 2 Diabetes (SURPASS-2). NEJM.", doi: "10.1056/NEJMoa2107519" },
    ],
  },
