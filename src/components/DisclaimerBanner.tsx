...
export function DisclaimerBanner() {
  ...
  return (
    <div
      ...
      className="w-full bg-[#1a1a2e] border-b border-[#2a2a3e] py-1.5 px-4"
      style={{
        position: 'fixed',
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-2">
        <span className="text-[10px] md:text-xs text-gray-400 tracking-wider uppercase whitespace-nowrap overflow-hidden text-ellipsis">
